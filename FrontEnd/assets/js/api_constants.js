const API_BASE = "http://localhost:13946/"

const GET_USER = API_BASE + "api/user"
const POST_USER = API_BASE + "api/user"

const GET_AIRCRAFT_TYPES = API_BASE + "api/aircrafttype"
const POST_AIRCRAFT_TYPE = API_BASE + "api/aircrafttype"

const GET_AIRCRAFT_LIST = API_BASE + "api/aircraft"
